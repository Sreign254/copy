						  ...
						  <table class="table">
							...
							<tbody>
							  <tr>
								...
								<td>Sam David</td>
								<td>
									<button onclick="window.location.href='preview.php' " class="btn btn-primary"> View</button>
									<td>
							  </tr>
							  ...
							  <tr>
								...
								<td>Sara David</td>
								<td>
									<button onclick="window.location.href='preview.php' " class="btn btn-primary"> View</button></td>
							  </tr>
